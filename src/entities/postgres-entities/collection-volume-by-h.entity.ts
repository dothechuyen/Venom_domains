...
@Index(
  'collection_volume_by_h_collection_address_idx',
  ['collectionAddress'],
  {},
)
@Index('collection_volume_by_h_log_timestamp_idx', ['logTimestamp'], {})
@Entity('collection_volume_by_h')
export class CollectionVolumeByHourEntity {
  @PrimaryGeneratedColumn()
  id: number;
